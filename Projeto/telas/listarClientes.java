...
public class listarClientes extends javax.swing.JFrame {
   ...
   DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
       ...
       clearTable();
        ...
        if (jRadioButton3.isSelected()){
            ...
            while(rs.next()){
                ...
                long cnh = rs.getLong("cnh");
              
                System.out.println(cnh);
                model.addRow(new Object[]{nome,cnh,telefone});
            }            
        }else if(jRadioButton4.isSelected()){
            ResultSet rs = clie.retrivecnh(jTextField1.getText());
            while(rs.next()){
                String nome = rs.getString("nome");
                String telefone = rs.getString("telefone");
                long cnh = rs.getLong("cnh");            
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       String CNH = (jTable1.getValueAt(linha, 1)).toString();
       Clientes clie = new Clientes(con);
       Enderecos end = new Enderecos(con);
       int fk_endereco = clie.delete(CNH);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int linha =  jTable1.getSelectedRow();
        String CNH = (jTable1.getValueAt(linha, 1)).toString();
        new editarCliente(CNH,con).setVisible(true);
        }catch(java.lang.ArrayIndexOutOfBoundsException e){
            JOptionPane.showMessageDialog(this, "Selecione um cliente.");
        }
    ...
    private static class detalhesCliente {

        public detalhesCliente(String CNH, Connection con) {
        }
    }
}
