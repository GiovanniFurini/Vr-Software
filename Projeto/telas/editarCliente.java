...
import conn.Conexao;
import sist.Cidades;
import sist.Clientes;
import sist.Enderecos;
import sist.Estados;
import sist.Paises;
...
public class editarCliente extends javax.swing.JFrame {
     ...
     */
    public editarCliente(String CNH, Connection con) {
        this.CNH = CNH;
        this.con = con;
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       long cnh = Long.parseLong(jTextField9.getText());
       ...
       String cep = ""+jFormattedTextField8.getText();
         ...
         try{
       Cidades c = new Cidades(con);
       int idd = c.retriveid(""+jComboBox7.getSelectedItem());
       Endereco end = new Endereco(bairro,cep,complemento,numero,rua,idd);
       Enderecos endDAO = new Enderecos(con);
       endDAO.update(end, fk_endereco);
       
       
       Cliente clie = new Cliente(cnh,fk_endereco,nome,email,dtnascimento,telefone);
       Clientes clieDAO = new Clientes(con);
       clieDAO.update(clie);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try{
            ...
            Clientes clie = new Clientes(con);
            Enderecos end = new Enderecos(con);
            Cidades cid = new Cidades(con);
            Estados est = new Estados(con);
            ...
            ResultSet rs = clie.retrivecnh(CNH);
            while(rs.next()){
                jTextField3.setText(rs.getString("nome"));
                jTextField9.setText(rs.getString("cnh"));
