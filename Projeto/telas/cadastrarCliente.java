...
public class cadastrarCliente extends javax.swing.JFrame {
     ...
     */
    public cadastrarCliente(Connection con) { 
        initComponents();
        this.con = con;
    ...
    public cadastrarCliente(JFrame home) {
         this.home = home;
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try{
           ...
           JOptionPane.showMessageDialog(this, "Digite um cnh valido: Máx 10 caracteres!");
       }
       ...
       int fk_endereco = endDAO.create(end);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       try{
           ...
           jComboBox4.addItem("Selecione");
           ResultSet rs;
           
           Paises p = new Paises(con);
    ...
    private void jComboBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox4ActionPerformed
        ...
        if(jComboBox4.getSelectedItem() != "Selecione"){
        jComboBox5.removeAllItems();
        try{
            
           Paises p = new Paises(con);
           Estados u = new Estados(con);
           String np = ""+jComboBox4.getSelectedItem();
           int idd = p.retriveid(np);
           ResultSet rs = u.retrive(idd);
           while (rs.next()){
               String nome = rs.getString("nome");
               jComboBox5.addItem(nome);
           }
           ...
           System.out.println("erro de noob");
            ...
            jComboBox5.removeAllItems();
            jComboBox5.addItem("Selecione");
        }
        
    }//GEN-LAST:event_jComboBox4ActionPerformed

    private void jComboBox5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox5ActionPerformed
        if(jComboBox5.getSelectedItem() != "Selecione"){
